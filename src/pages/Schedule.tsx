...
const Schedule = () => {
  return (
    <div>
      <Flex mx="auto" align="center" justify="center" my={10} py={5}>
        <Box rounded="lg" bg="white" boxShadow="lg" w="70%">
          <Heading as="h3" size="lg" ps={0} py={4}>
            Jadwal Imunisasi
          </Heading>
                  ...
                  <Tr>
                    ...
                    <Td>
                      <UnorderedList>
                        ...
                        <Text mt={1}>
                          Mencegah penularan penyakit hepatitis B dan kerusakan
                          hati
                        </Text>
                      </UnorderedList>
                    </Td>
                  ...
                  <Tr>
                    ...
                    <Td>
                      <UnorderedList>
                        ...
                        <Text mt={1}>
                          Mencegah penularan penyakit TBC (Tuberkolosis) yang
                          berat
                        </Text>
                        <ListItem mt={3}>Polio 1</ListItem>
                        <Text mt={1}>
                          Mencegah penularan penyakit Polio yang dapat
                          menyebabkan lumpuh <br /> layuh pada tungkai dan atau
                          lengan
                        </Text>
                      </UnorderedList>
                    </Td>
                  ...
                  <Tr>
                    ...
                    <Td>
                      <UnorderedList>
                        ...
                        <Text mt={1}>
                          Mencegah penularan penyakit Polio yang dapat
                          menyebabkan lumpuh layuh <br /> pada tungkai dan atau
                          lengan
                        </Text>
                      </UnorderedList>
                    </Td>
                    ...
                    <Td>
                      <UnorderedList>
                        ...
                        <Text mt={2}>
                          ...
                          mengakibatkan <br /> komplikasi radang paru, radang
                          otak dan kebutaan
                        </Text>
                      </UnorderedList>
                    </Td>
